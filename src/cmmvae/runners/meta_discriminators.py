...
def create_dataloader(batch_size: int):
    ...
    mm_loader = multi_modal_loader.MultiModalDataLoader(human_dataloader, mouse_dataloader)
...
def run_md_tests(log_directory, checkpoint_path, config_path):
    ...
    latent_dim = config["model"]["init_args"]["module"]["init_args"]["vae"]["init_args"]["latent_dim"]
